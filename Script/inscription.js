...
document.querySelector("#form-professionnel .btn-submit")?.addEventListener(
    "click", function(e){
        e.preventDefault();
        ...
        const password = document.querySelector("mdp")?.value.trim();
        const cgu = document.querySelector("cgu-pro")?.checked;
